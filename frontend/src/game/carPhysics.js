...
export const TOP_SPEED = 400.0;
export const MAX_REVERSE_SPEED = 150.0;
export const ACCELERATION = 160.0;
export const BRAKE_DECELERATION = 300.0;
export const FRICTION = 1.5;
export const TURN_SPEED = 3.0;
export const MIN_TURN_SPEED = 10.0;
export const GRIP = 3.0;
export const DRIFT_THRESHOLD = 150.0;
export const CENTRIFUGAL_FACTOR = 0.15;

// Handbrake constants
export const HANDBRAKE_GRIP = 0.3; // Much lower grip when handbraking
export const HANDBRAKE_DECELERATION = 400.0; // Strong deceleration
export const HANDBRAKE_TURN_BOOST = 1.8; // Increased turn rate
...
export const TRACK_CONFIG = {
  ...
  innerRadiusX: 280,
  innerRadiusY: 160,
  trackWidth: 240, // Approximate track width
};
...
export const RESPAWN_POINTS = [
  { x: 120, y: 400, angle: -Math.PI / 2 },   // Left side, facing up
  { x: 600, y: 720, angle: 0 },              // Bottom, facing right
  { x: 1080, y: 400, angle: Math.PI / 2 },   // Right side, facing down
  { x: 600, y: 80, angle: Math.PI },         // Top, facing left
];
...
export const STARTING_POSITIONS = [
  { x: 120, y: 460, angle: -Math.PI / 2 },
  { x: 120, y: 520, angle: -Math.PI / 2 },
  { x: 180, y: 460, angle: -Math.PI / 2 },
  { x: 180, y: 520, angle: -Math.PI / 2 },
];
